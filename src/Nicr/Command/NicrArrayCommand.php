 ...
 */
class NicrArrayCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        if (!is_readable($file)) {
            $output->writeln(sprintf("<error>The nicr:array command does not have acces to the given file (%s), make sure you execute the command with enough permissions</error>", $file));
            return 1;
        }
